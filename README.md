...
Questions to answer
    ...
    Can the model select the appropriate HOF canditate.
    Accuracy of the model overall
    Does previous awards help identify players that may be inducted
    Does player popularity effect the election results.
    Does statistical performance predict candidates
